...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/images/logo_icon/ss_logo_favicon.ico">
    <meta name="description" content="Decor SS Ganja - Zövqünüzə uyğun dekorlar!">
    <meta property="og:title" content="Decor SS Ganja">
    <meta property="og:image" content="assets/images/logo_icon/ss_ganja_logo.png">
